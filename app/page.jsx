    ...
    <div className="flex flex-col !pt-16">
        ...
        <div className="container !mx-auto !mb-15 !px-4 md:!px-6 text-center space-y-6">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row justify-center">
            <Button
              asChild
              size="lg"
              className="bg-green-600 hover:bg-green-700 !px-2 !py-4"
            >
              <Link href="/dashboard">
                Get Started
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-green-600 text-green-600 hover:bg-green-50 !px-2 !py-4"
            >
          ...
          <div className="!mx-auto !mt-12 grid max-w-5xl gap-8 md:grid-cols-3">
            {STEPS.map(({ label, title, description }) => (
              <div key={label} className="flex flex-col items-center space-y-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-green-100 text-xl font-bold text-green-600 !mb-4">
                  {label}
                </div>
      ...
      <section className="!py-20 gradient">
        <div className="container !mx-auto  !px-4 md:!px-6 text-center space-y-6">
          ...
          <p className="!mx-auto max-w-[600px] text-green-100 md:text-xl/relaxed !mb-6 ">
          ...
          <Button
            asChild
            size="lg"
            className="bg-green-800 hover:opacity-90 !px-2 !py-4"
          >
            <Link href="/dashboard">
              Get Started
              <ArrowRight className="!ml-2 h-4 w-4" />
