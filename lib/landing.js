...
export const TESTIMONIALS = [
  {
    quote:
      "Splitr has made managing shared expenses with my roommates so simple—no more confusion or awkward money conversations.",
    name: "Aarohi Mehta",
    image: "/testimonials/testimonial_image_1.png",
    role: "Software Engineer",
  },
  {
    quote:
      "Our trip planning is now stress-free. The smart settlements feature saved us hours of manual calculations.",
    name: "Priya Sharma",
    image: "/testimonials/testimonial_image_2.png",
    role: "Travel Blogger",
  },
  {
    quote:
      "I use Splitr with my colleagues to track office lunch expenses. It's simple, fast, and keeps everything transparent.",
    name: "Riya Gupta",
    image: "/testimonials/testimonial_image_3.png",
